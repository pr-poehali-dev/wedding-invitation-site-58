  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-secondary/20 to-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-[768px] h-[768px] bg-[url('https://cdn.poehali.dev/projects/YCAJEcx7i4qLKeyKMd-Dc26R61sGbwN-/bucket/eucalyptus-branch-1.png')] bg-contain bg-no-repeat opacity-60 animate-fade-in"></div>
        <div className="absolute bottom-0 right-0 w-[512px] h-[512px] bg-[url('https://cdn.poehali.dev/projects/YCAJEcx7i4qLKeyKMd-Dc26R61sGbwN-/bucket/eucalyptus-branch-2.png')] bg-contain bg-no-repeat opacity-60 animate-fade-in" style={{ animationDelay: '0.2s' }}></div>
      ...
      <section className="relative py-20 px-4 bg-secondary/30">
        {/* Decorative branch */}
        <div className="absolute top-0 left-0 w-[384px] h-[384px] bg-[url('https://cdn.poehali.dev/projects/YCAJEcx7i4qLKeyKMd-Dc26R61sGbwN-/bucket/eucalyptus-branch-2.png')] bg-contain bg-no-repeat opacity-60 rotate-180"></div>
